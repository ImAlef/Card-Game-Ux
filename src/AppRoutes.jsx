  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path="/hokm-lobby/:lobbyId" element={<HokmLobby />} />
        ...
        {/* New routes for the components we've created */}
        ...
        {/* 404 page */}
        <Route path="*" element={
          <div className="min-h-screen bg-arcane flex flex-col items-center justify-center p-10">
